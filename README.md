...
1) Open an account on [Tip4serv.com](https://tip4serv.com/?ads=github).
2) Fill in the requested information in [MY SETTINGS](https://tip4serv.com/dashboard/my-settings)
3) Add a FiveM server in [MY SERVERS](https://tip4serv.com/dashboard/my-servers) and follow the instructions requested
...
[ESX framework](https://esx-framework.org) and [es_extended](https://github.com/ESX-Official/es_extended) are required
